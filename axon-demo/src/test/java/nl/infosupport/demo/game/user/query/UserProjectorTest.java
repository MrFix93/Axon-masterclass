...
class UserProjectorTest {
    ...
    void testUserRegisteredEvent() {
        ...
        final ArgumentCaptor<nl.infosupport.demo.game.user.query.readmodels.User> captor = ArgumentCaptor.forClass(nl.infosupport.demo.game.user.query.readmodels.User.class);
        ...
        final nl.infosupport.demo.game.user.query.readmodels.User savedUser = captor.getValue();
